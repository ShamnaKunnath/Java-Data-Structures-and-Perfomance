...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
		...
		boolean t=list1.add(32);
		assertEquals("AddEnd: check return value", true, t);
		assertEquals("AddEnd: check end is correct ", (Integer)32, list1.tail.prev.data);
		assertEquals("AddEnd: check element is added at the correct end", (Integer)42, list1.tail.prev.prev.data);
	...
	public void testSet()
	{
		...
		int a=list1.set(2,1);
		assertEquals("set: check return value", a, 42);
		assertEquals("set: check value is at the correct index", (Integer)1, list1.get(2));
